                        ...
                        <div class = "login-wrap p-4 p-md-5">
                            ...
                            <form action = "#" class = "login-form">
                                ...
                                <div style = "text-align: center;
                                 font-weight: 700;font-size: 14px;color: #8d448b; margin:20px 0;" >
                                    Əgər Hesabınız yoxdursa qeydiyyatdan keçə bilərsiniz
                                ...
                                <div class = "form-group">
                                    <button type = "button" @click = "submit()"
                                            class = "btn btn-primary rounded submit p-3 px-5">Login
                                    </button>
                                </div>
                            </form>
                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                ...
                axios.post('http://localhost:8000/api/login', this.data)
                    .then(function (e) {
